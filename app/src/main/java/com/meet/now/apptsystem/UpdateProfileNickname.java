...
public class UpdateProfileNickname extends DialogFragment {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userNickname.equals(null)) {
                    Toast.makeText(getContext(), "별칭을 입력해주세요.", Toast.LENGTH_SHORT).show();
                } else {
                    if (userID.equals(MyApplication.userID)) {
                        ...
                        Async_friendNick async_friendNick = new Async_friendNick();
                        async_friendNick.execute(userID, friendID, userNickname);
    ...
    class Async_friendNick extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                String friendNickname = params[2];

                String data = URLEncoder.encode("userID", "UTF-8") + "=" + URLEncoder.encode(userID, "UTF-8");// UTF-8로  설정 실제로 string 상으로 봤을땐, tmsg="String" 요런식으로 설정 된다.
                data += "&" + URLEncoder.encode("friendID", "UTF-8") + "=" + URLEncoder.encode(friendID, "UTF-8");
                data += "&" + URLEncoder.encode("friendNickname", "UTF-8") + "=" + URLEncoder.encode(friendNickname, "UTF-8");

                String link = "http://brad903.cafe24.com/" + "FriendNicknameUpdate.php";// 요청하는 url 설정 ex)192.168.0.1/httpOnlineTest.php
    ...
    public void setDialogResult(MyDialogResult myDialogResult){
